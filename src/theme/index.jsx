...
import Tree from './ZyComponents/Tree'
    ...
    return (
        ...
        >
            ...
            <button
                ...
                className={`absolute top-5 right-5 z-[9999] rounded-md text-white px-3 py-2 cursor-pointer text-xs ${showBg ? 'bg-black/70' : 'bg-white/80/10'
                    }`}
            >
                {showBg ? 'Hide BG' : 'Show BG'}
            </button> */}

            <main className='relative flex z-[9000] p-6 gap-4 bg--[#ebebf5] app-bg'>
                <NavDrawer />
                <div className='flex-1 pb-20 min-h-screen h-screen w-full rounded-3xl flex flex-col overflow-scroll'>
                    ...
                    {1 && <Tree />}
                    {false && <ZyComponents />}
                    {false && <div className='flex mt-6 gap-6'>

                        <div className='w-[60%] flex-[0.6] flex flex-col gap-6'>
                            <div className='grid grid-cols-2 gap-6'>
                                {/* Top Left Tile */}
                                {[1, 2, 3, 4].map(_ => {
                                    return <ZyCard className='bg-white/80 text-gray-800 rounded-3xl p-5'>
                            ...
                            <div className='bg-white/80  p-6 flex flex-col rounded-3xl'>
